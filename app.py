...
with tab5:
    ...
    with col1:
        ...
        if st.button("📤 Send to Telegram", key="send_telegram") and pdf_generation_successful:
        ...
        elif st.button("📤 Send to Telegram", key="send_telegram") and not pdf_generation_successful:
